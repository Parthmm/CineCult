...
function UserStatistics() {
    ...
    return (
        <div className={styles.form_background}>
            ...
            <h2>Your favorite movie was {topMovies[0][1]} you gave it a rating of {topMovies[0][2]}</h2>

            <h2>Your favorite tv show was  {topShows[0][1]}, you gave it a rating of {topShows[0][2]}</h2>

            <h2>Here is how many reviews for movies you wrote : {numMovieReviews}</h2>

            <h2>Here is how many reviews for tv shows you wrote: {numTVReviews}</h2>
